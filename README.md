...
Or maybe you want to wipe your devices as part of an MDM migration 💀.
...
At the moment, only Self-Service erase is supported, but I'd like to add this when I find the time... PRs welcome! ❤️
...
⚠️ So, **here's the disclaimer** - I'm not an expert (Go) programmer; you may find bugs or see things you don't like (yes, I still need to write tests).
I cannot be held responsible for anything (bad) that happens if you use (or don't use) the code in any of the repos on my GitHub. Use at your own risk, see LICENSE, etc. ⚠️
...
### Test from a client
**☠️ THIS WILL ERASE THE TARGET CLIENT IF YOU ALREADY SET EVERYTHING UP ON THE JAMF SIDE ☠️**
